...
var SecretInput = ({
  ...
  const [visible, setVisible] = (0, import_react.useState)(!toggleVisible);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className, children: [
    label && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: cn("mb-5 px-1 text-base font-bold max-sm:mb-3"), children: label }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "div",
      {
        className: cn(`form-field flex w-full`, inputClassName),
        ...
        children: [
          ...
          toggleVisible && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "button",
            {
              ...
              "aria-label": visible ? "\u96B1\u85CF\u8EAB\u5206\u8B49\u5B57\u865F" : "\u986F\u793A\u8EAB\u5206\u8B49\u5B57\u865F",
              className: "pl-2",
    ...
    errorMessage && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "form-message", children: errorMessage })
  ] });
};
